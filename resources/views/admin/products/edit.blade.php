    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-floating mb-3">
                <textarea class="form-control @error('small_description') is-invalid @enderror" placeholder="Leave a description here"
                    id="floatingTextarea2" name="small_description">{{ $product->small_description }}</textarea>
